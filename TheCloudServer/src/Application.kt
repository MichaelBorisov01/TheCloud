...
fun Application.module(testing: Boolean = false) {
    ...
    routing {
        ...
        get("/queries/4") { call.respond(theCloudController.getMoscowCust()) }
        get("/queries/5") { call.respond(theCloudController.getAll()) }
        get("/queries/6") { call.respond(theCloudController.getAll()) }
        get("/queries/7") { call.respond(theCloudController.getAll()) }
        get("/queries/8") { call.respond(theCloudController.getAll()) }
        get("/queries/9") { call.respond(theCloudController.getAll()) }
